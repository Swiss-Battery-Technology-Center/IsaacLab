...
@configclass
class NeuralNetworkControllerActionCfg(ActionTermCfg):
    """Configuration for neural network controller action term.

    See :class:`NeuralNetworkControllerAction` for more details.
    """
